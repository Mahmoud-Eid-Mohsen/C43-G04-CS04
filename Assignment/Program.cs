...
namespace Assignment
{
    ...
    public static int FindLongestDistance(int[] arr)
    {
        ...
        Console.Write("Enter a number to convert: ");
            ...
            #endregion
                #region Q12
            //12- Write a program in C# Sharp to merge two arrays of the same size sorted in ascending order.
            int[] arr01 = { 1, 2, 3, 4, 5 }; 
           int[] arr02 = { 6, 7, 8, 9, 10 }; 
            int[] mergedArray = new int[10];
            // Copy elements from arr01 to mergedArray
            Array.ConstrainedCopy(arr01,0,mergedArray, 0, arr01.Length);
            // Copy elements from arr02 to mergedArray
            Array.ConstrainedCopy(arr02, 0, mergedArray, arr01.Length, arr02.Length);
            ...
            { Console.WriteLine(item); }
                ...
                for (int i = 0; i < num01.GetLength(0); i++)
                {
                    for (int j = 0; j < num01.GetLength(1); j++)
                    {
                        num02[i, j] = num01[i, j];
                ...
                for (int i = 0; i < num02.GetLength(0); i++)
                {
                    for (int j = 0; j < num02.GetLength(1); j++)
                    {
                        Console.Write(num02[i, j]);
                        Console.Write(" ");
                    }
                    Console.WriteLine();
                }
